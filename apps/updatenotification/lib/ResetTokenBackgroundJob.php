...
class ResetTokenBackgroundJob extends TimedJob {
	...
	protected function run($argument) {
		...
		if ($this->config->getSystemValueBool('config_is_read_only') === false && $this->timeFactory->getTime() - $this->config->getAppValue('core', 'updater.secret.created', $this->timeFactory->getTime()) >= 172800) {
